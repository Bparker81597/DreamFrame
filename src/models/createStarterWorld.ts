...
export function createStarterWorldUser(input: CreateStarterUserInput): DreamUser {
  ...
  return recalculateLevels({
    ...
    betaFeedback: initialUser.betaFeedback,
    betaErrorLogs: initialUser.betaErrorLogs,
    betaGenerationUsage: initialUser.betaGenerationUsage,
    betaDebug: initialUser.betaDebug,
